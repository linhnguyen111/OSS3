						...
						<div class="d-none d-md-block col-md-8 offset-md-4">
							<!-- <div class="left-menu">
								<ul id="menu-top-menu" class="left-menu">
									<li id="menu-item-12" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-12"><a href="https://www.vitinhducthanh.com/" aria-current="page">Trang chủ</a></li>
									<li id="menu-item-14" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14"><a href="https://www.vitinhducthanh.com/gioi-thieu">Giới thiệu</a></li>
						...
						<div id="header-slider" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img src="https://www.vitinhducthanh.com/wp-content/uploads/2020/11/68756711_2440219026072164_5018162852897226752_n.jpg" class="d-block w-100" alt="Chào đón tân sinh viên 2020">
